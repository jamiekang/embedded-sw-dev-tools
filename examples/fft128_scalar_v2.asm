...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	.VAR	y7[256]		; output array (complex pair)			- IWL:7 (0x700)
...
; * Simulator paramters:
;
; dspsim fft128_scalar_v2.asm -if fft128_w.dat -of fft128_wout1.dat -oa 000 -os 2304 -c -q >! fft128_scalar_v2.dspsim.txt
; binsim fft128_scalar_v2.out -if fft128_w.dat -of fft128_wout2.dat -oa 000 -os 2304 -c -q >! fft128_scalar_v2.binsim.txt
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; * Simulator version:
;
; dspsim: OFDM DSP Simulator 1.4
; All Rights Reserved.
; Last Built: Jun  5 2009 16:03:42
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; * Simulator output:
;
;----------------------------------
...
;----------------------------------
;Time: 6574 cycles for 1 iteration
;Overflow: 0 times
;
; * Note: 6574 - 259(Coeff init.) - 8(ending NOPs) = 6307 cycles
;
