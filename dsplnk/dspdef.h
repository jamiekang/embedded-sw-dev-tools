...
enum eOp
{
	...
	i_GLOBAL, i_EXTERN, i_VAR, i_CODE, i_DATA,
...
enum eField {
	...
	fDSTB, fTERM, fINTN, fU, fU2,
	fS, fT, fLPP, fPPP, fSPP, 
	fC, fCONJ, fENA, fPOLAR, fDD, 
	fPD, fDMI, fDMM, fPMI, fPMM, 
	fDC, fLSF, fDF, fMN, 
	fReserved, 
	fCOND
};
...
enum eImmType {
	...
	eIMM_UINT4, eIMM_UINT12, eIMM_UINT16,
};
